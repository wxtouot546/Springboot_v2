...
@Api(value = "")
@Controller
@RequestMapping("/ThTaskController2")
public class ThTaskController2 extends BaseController{
	
	private String prefix = "gen/thTask2";
	@Autowired
	...
	@GetMapping("/view")
	@RequiresPermissions("gen:thTask:view2")
    public String view(ModelMap model)
    {	
		String str="";
		setTitle(model, new TitleVo("列表", str+"刷回复", true,"欢迎进入"+str+"页面", true, false));
        return prefix + "/list";
    }
	...
	@PostMapping("/list")
	@RequiresPermissions("gen:thTask:list2")
	@ResponseBody
	public Object list(Tablepar tablepar,String searchText){
		PageInfo<ThTask> page=thTaskService.list(tablepar,searchText,"2") ; 
	...
	@PostMapping("/add")
	@RequiresPermissions("gen:thTask:add2")
	@ResponseBody
	...
	@PostMapping("/remove")
	@RequiresPermissions("gen:thTask:remove2")
	@ResponseBody
    ...
    @RequiresPermissions("gen:thTask:edit2")
    @PostMapping("/edit")
    @ResponseBody
